"""Hatch build hook for platform-specific Ubuntu VM image wheels."""
...
def _read_distro_version(root: Path) -> str:
    ...
    init_file = root / "quicksand_ubuntu" / "__init__.py"
...
class UbuntuImageBuildHook(BuildHookInterface):
    """Build hook that packages Ubuntu VM images with platform-specific wheel tags."""

    PLUGIN_NAME = "ubuntu-image"
    ...
    def initialize(self, version: str, build_data: dict) -> None:
        ...
        pkg_dir = Path(self.root) / "quicksand_ubuntu"
    ...
    def _build_image(self, dockerfile: Path, output: Path) -> None:
        ...
        try:
            ...
            build_log = logging.getLogger("quicksand-ubuntu")
